    ...
    <div className="wrapper">
      ...
      <div className="content">
        ...
        <div className="sneakers">
          ...
          <div className="card">
            <img className="card__img" width={133} height={112} src="/img/sneakers/2.jpg" alt="" />
            <p className="card__text">Мужские Кроссовки Nike Blazer Mid Suede</p>
            <div className="card__bottom">
              <div className="card__price">
                <span className="card__price-title">Цена:</span>
          ...
          <div className="card">
            <img className="card__img" width={133} height={112} src="/img/sneakers/3.jpg" alt="" />
            <p className="card__text">Мужские Кроссовки Nike Blazer Mid Suede</p>
            <div className="card__bottom">
              <div className="card__price">
                <span className="card__price-title">Цена:</span>
          ...
          <div className="card">
            <img className="card__img" width={133} height={112} src="/img/sneakers/4.jpg" alt="" />
            <p className="card__text">Мужские Кроссовки Nike Blazer Mid Suede</p>
            <div className="card__bottom">
              <div className="card__price">
                <span className="card__price-title">Цена:</span>
